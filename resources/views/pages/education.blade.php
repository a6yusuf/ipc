        ...
        <div class="container mx-auto px-4">
          <div class="items-center flex flex-wrap">
            ...
            <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                <h2 style="font-family: 'Roboto Condensed', sans-serif;" class="text-3xl font-semibold mb-1 italic">About our learning institutes</h2>
        ...
        <div class="container mx-auto px-4 md:w-10/12 w-full">
            <div class="flex flex-wrap justify-center text-center mb-10">
                <div class="w-full lg:w-6/12 px-2 flex flex-col justify-center items-center">
                  <h2 style="font-family: 'Roboto Condensed', sans-serif;" class="text-4xl font-semibold mb-1">Our Madrasah</h2>
            ...
            <div class="flex flex-col md:flex-row">
                <div class="group-box rounded hover:shadow-2xl md:w-4/12 w-full mb-10 mx-5 relative ease-linear transition-all duration-150">
                    ...
                    />
                    <div class="location invisible bg-white shadow-2xl rounded absolute top-48 left-5 text-black text-base p-2 flex justify-center items-center ease-linear transition-all duration-150" style="width: fit-content; height: 70px; font-size: 30px">Enugu</div>
                    <div>
                        <h6 style="font-family: 'Roboto Condensed', sans-serif;" class="block text-black text-2xl font-medium m-5">
                            Daily Tahfeez For Males
                        </h6>
                ...
                <div class="group-box rounded hover:shadow-2xl md:w-4/12 w-full mb-10 mx-5 relative ease-linear transition-all duration-150">
                    ...
                    />
                    <div class="location invisible bg-white shadow-2xl rounded absolute top-48 left-5 text-black text-base p-2 flex justify-center items-center ease-linear transition-all duration-150" style="width: fit-content; height: 70px; font-size: 30px">Bayelsa</div>
                    <div>
                        <h6 style="font-family: 'Roboto Condensed', sans-serif;" class="block text-black text-2xl font-medium m-5">
                            Daily Tahfeez class For Females
                        </h6>
                        <p style="font-family: 'Inter', sans-serif;" class="m-5 text-gray-700">
                            Lorem ipsum dolor sit amet  dolor sit amet consectetur adipisicing elit dolor sit amet. Exercitationem corrupti aperiam. Repellat optio amet ipsa.
                        </p>
                ...
                <div class="group-box rounded hover:shadow-2xl md:w-4/12 w-full mb-10 mx-5 relative ease-linear transition-all duration-150">
                    ...
                    />
                    <div class="location invisible bg-white shadow-2xl rounded absolute top-48 left-5 text-black text-base p-2 flex justify-center items-center ease-linear transition-all duration-150" style="width: fit-content; height: 70px; font-size: 30px">Asaba</div>
                    <div>
                        <h6 style="font-family: 'Roboto Condensed', sans-serif;" class="block text-black text-2xl font-medium m-5">
                            Tahfeez class For the elders
                        </h6>
                        <p style="font-family: 'Inter', sans-serif;" class="m-5 text-gray-700">
                            Lorem ipsum dolor sit amet  dolor sit amet consectetur adipisicing elit dolor sit amet. Exercitationem corrupti aperiam. Repellat optio amet ipsa.
                        </p>
            ...
            <div class="flex flex-col md:flex-row">
                <div class="group-box rounded hover:shadow-2xl md:w-4/12 w-full mb-10 mx-5 relative ease-linear transition-all duration-150">
                    ...
                    />
                    <div class="location invisible bg-white shadow-2xl rounded absolute top-48 left-5 text-black text-base p-2 flex justify-center items-center ease-linear transition-all duration-150" style="width: fit-content; height: 70px; font-size: 30px">Porthacourt</div>
                    <div>
                        <h6 style="font-family: 'Roboto Condensed', sans-serif;" class="block text-black text-2xl font-medium m-5">
                ...
                <div class="group-box rounded hover:shadow-2xl md:w-4/12 w-full mb-10 mx-5 relative ease-linear transition-all duration-150">
                    ...
                    />
                    <div class="location invisible bg-white shadow-2xl rounded absolute top-48 left-5 text-black text-base p-2 flex justify-center items-center ease-linear transition-all duration-150" style="width: fit-content; height: 70px; font-size: 30px">Bayesla</div>
                    <div>
                        <h6 style="font-family: 'Roboto Condensed', sans-serif;" class="block text-black text-2xl font-medium m-5">
                            Daily arabic class for kids
                        </h6>
                        <p style="font-family: 'Inter', sans-serif;" class="m-5 text-gray-700">
                            Lorem ipsum dolor sit amet  dolor sit amet consectetur adipisicing elit dolor sit amet. Exercitationem corrupti aperiam. Repellat optio amet ipsa.
                        </p>
                ...
                <div class="group-box rounded hover:shadow-2xl md:w-4/12 w-full mb-10 mx-5 relative ease-linear transition-all duration-150">
                    ...
                    />
                    <div class="location invisible bg-white shadow-2xl rounded absolute top-48 left-5 text-black text-base p-2 flex justify-center items-center ease-linear transition-all duration-150" style="width: fit-content; height: 70px; font-size: 30px">Uyo</div>
                    <div>
                        <h6 style="font-family: 'Roboto Condensed', sans-serif;" class="block text-black text-2xl font-medium m-5">
                            Daily arabic class for adult
                        </h6>
                        <p style="font-family: 'Inter', sans-serif;" class="m-5 text-gray-700">
                            Lorem ipsum dolor sit amet  dolor sit amet consectetur adipisicing elit dolor sit amet. Exercitationem corrupti aperiam. Repellat optio amet ipsa.
                        </p>
